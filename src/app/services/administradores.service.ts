...
export class AdministradoresService {
  ...
  public registrarAdmin(data: any): Observable<any> {
    ...
    return this.http.post<any>(`${environment.url_api}/api/admins/create/`, data, { headers });
  }
  ...
  public obtenerListaAdmins(): Observable<any> {
    ...
    return this.http.get<any>(`${environment.url_api}/api/admins/list/`, { headers });
  }
  ...
  public obtenerAdminPorID(idAdmin: number): Observable<any> {
    ...
    return this.http.get<any>(`${environment.url_api}/api/admins/detail/?id=${idAdmin}`, { headers });
  }
  ...
  public actualizarAdmin(data: any): Observable<any> {
    ...
    return this.http.put<any>(`${environment.url_api}/api/admins/update/`, data, { headers });
  }
  ...
  public eliminarAdmin(idAdmin: number): Observable<any> {
    ...
    return this.http.delete<any>(`${environment.url_api}/api/admins/delete/?id=${idAdmin}`, { headers });
  }
