...
import { RegistoMateriaScreenComponent } from './screens/registo-materia-screen/registo-materia-screen.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'materias', component: MateriaScreenComponent },
      { path: 'registro-materia', component: RegistoMateriaScreenComponent },
      { path: 'registro-materia/:id', component: RegistoMateriaScreenComponent }
    ]
  },
  // fallback route
